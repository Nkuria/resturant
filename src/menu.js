import {mainFood as mainFood, salads as salads, drinks as drinks, deserts as deserts} from './menuObject';
...
function foodLoops() {
    ...
    function MainFoodPart () {
        ...
        for(let i = 0; i < salads.length; i++){
            ...
            const saladNameText = document.createTextNode(mainFood[i].name + "..................................................." + mainFood[i].price);
    ...
    function desertsPart () {
        ...
        for(let i = 0; i < salads.length; i++){
            const saladName = document.createElement('p');
            const saladNameText = document.createTextNode(salads[i].name + "..................................................." + salads[i].price);
            saladName.classList.add('salad-name');
            saladName.appendChild(saladNameText);
            leftMenu.appendChild(saladName);
